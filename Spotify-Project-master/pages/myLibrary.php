            ...
            <div class="track-container">
                ...
                <div class = "content">
                    ...
                    <div class = "song-upload">
                        ...
                        <script type="text/javascript" src="../scripts/myLibrarySongActions.js"></script>
                    ...
                    <?php
                        ...
                        $playlists_table_name = "playlists" . $id;
                        $query_playlists_list = "select distinct(playlist) from `".$playlists_table_name."`";

                        $songs_data = $mysqli->query($query_songs_list);
                        $friends_data = $mysqli->query($query_friends_list);
                        $playlists_data = $mysqli->query($query_playlists_list);
                                ...
                                echo '<div class="song-content">
                                    ...
                                    <button class="songs-list-button dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <p id=\'msgplaylistForm'.$song_adress.'\' class = "message-box">Add song to playlist:</p>
                                            <form id=\'playlistForm'.$song_adress.'\'>
                                                <div class = "checkbox-container">';
                                                //printing the content of the Add Song To Playlist dropdown window
                                                if($playlists_data && $playlists_data->num_rows > 0){
                                                    while($playlist = mysqli_fetch_assoc($playlists_data)){
                                                        echo '<input type="checkbox" name=\''.$playlist['playlist'].'\'>
                                                            <label for=\''.$playlist['playlist'].'\' class="checkbox-label">'.$playlist['playlist'].'</label><br>';
                                                    }
                                                }
                                                else{
                                                ...
                                                <input class="new-playlist-field" name = "new_playlist" placeholder="Enter new playlist name...">
                                                <p class="share-button" onclick="return submitAddToPlaylistForm(\'playlistForm'.$song_adress.'\', event);">Add<p>';
                                                 
                                                mysqli_data_seek($playlists_data,0);//resetting the pointer
                                    ...
                                    <button class="songs-list-button" onclick="deleteSong(\''.$song_adress.'\', \''.$cover_adress.'\', \''.$id.'\', \''.$username.'\');">
