                        ...
                        if($shared_songs_data->num_rows > 0)
                        {
                            while($shared_song = mysqli_fetch_assoc($shared_songs_data))
                            {
                                ...
                                echo '<div class="song-content">
                                    ...
                                    <button class="songs-list-button" onclick="acceptDiscardSong(\''.$song_adress.'\', \''.$shared_song['receiver_name'].'\', true);">
                                        <i class="fas fa-check"></i>
                                    </button>


                                    <button class="songs-list-button" onclick="acceptDiscardSong(\''.$song_adress.'\', \''.$shared_song['receiver_name'].'\', false);">
